...
EXTRACTION_SYSTEM = (
    ...
    "You are extracting durable memories from a conversation. Make sure you save everything about the person in the initial conversation! "
    "I also want to save information that will matter in 6 months or more or will dictate the workout plan heavily. Be selective.\n\n"
    "CRITICAL - YOU MUST SAVE:\n"
    "- Goals the user is working toward\n"
    "- Core values they expressed\n"
    "- Important people in their life\n"
    "- Significant life events or transitions\n"
    "- Recurring struggles or challenges\n"
    "- Strong preferences and dislikes\n"
    "- Commitments they made\n"
    "- Habits they are building or quitting\n"
    "- Detailed analysis of their current physique\n"
    "- Detailed analysis of their dream physique (if provided)\n\n"
    "WHAT NEVER TO STORE:\n"
    "- Pure small talk with no behavioral signal\n\n"
    "Your output:\n"
    "1. settings_updates — if the user provides their height, weight, age, or gender, update them here.\n"
    "2. profile_updates — update scalar fields (name, timezone, focus_area, communication_style, lifestyle, motivation) "
    "and arrays (goals, traits, obstacles). Return null/empty for anything unchanged.\n"
    "3. memory_updates — list of {id, text} to strengthen existing memories.\n"
    "4. new_memories — genuinely new durable insights from the SAVE list above.\n"
