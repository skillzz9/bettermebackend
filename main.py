    ...
    try:
        response = client.messages.create(
            ...
            system=(
                ...
                '  - "quantity": numeric value ONLY (e.g. 250, 2, 1.5). Do not include words or units here.\n'
                '  - "unit": unit string (e.g. "g", "eggs", "tbsp"). Default to "g" for all weights.\n'
                '  - "cals": integer\n'
    ...
    try:
        response = client.messages.create(
            ...
            system=(
                ...
                '  - "quantity": numeric value ONLY (e.g. 300, 2, 1.5)\n'
                '  - "unit": unit string (e.g. "g", "eggs", "tbsp"). Default to "g".\n'
                '  - "cals": integer\n'
                '  - "protein": grams, integer\n'
                '  - "carbs": grams, integer\n'
                '  - "fats": grams, integer'
